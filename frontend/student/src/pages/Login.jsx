  ...
  return (
    <div className="w-full max-w-md animate-slide-up px-3 sm:px-0 relative">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-5 sm:p-8 shadow-xl space-y-4 sm:space-y-5 relative overflow-hidden">
        {/* Simple Clean Loading Pill */}
        {isAnyLoading && (
          <div className="flex items-center justify-center gap-2.5 py-2 px-3.5 rounded-xl bg-orange-50 border border-orange-200/70 text-orange-800 text-xs font-semibold animate-fade-in">
            <span className="w-3.5 h-3.5 border-2 border-orange-600 border-t-transparent rounded-full animate-spin flex-shrink-0" />
