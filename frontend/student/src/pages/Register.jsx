  ...
  return (
    <div className="w-full max-w-md animate-slide-up">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-500 text-sm mt-1">Join CampusBite • NIT Jamshedpur</p>
      </div>
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl">
        ...
        {error && (
          <div className="bg-rose-50 border border-rose-200 text-rose-700 text-sm rounded-xl p-3 mb-6 font-medium">
            ⚠️ {error}
          </div>
        )}
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="flex gap-3 mt-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="btn btn-primary flex-1 btn-lg font-bold shadow-md"
              >
